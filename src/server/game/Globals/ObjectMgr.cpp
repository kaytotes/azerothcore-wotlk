...
void ObjectMgr::LoadGameobjects()
{
    ...
    //                           0                1   2    3           4           5           6
    std::string query = "SELECT gameobject.guid, id, map, position_x, position_y, position_z, orientation, "
    ...
    sScriptMgr->OnBeforeGameObjectsQueried(query);
...
void ObjectMgr::LoadQuests()
{
    ...
    sScriptMgr->OnBeforeQuestTemplatesQueried(query);
    ...
    //               0   1                2                  3
    query = "SELECT ID, EmoteOnComplete, EmoteOnIncomplete, CompletionText FROM quest_request_items";

    sScriptMgr->OnBeforeQuestRequestItemsQueried(query);
    ...
    sScriptMgr->OnBeforeQuestOfferRewardsQueried(query);
    ...
    //               0   1         2                 3              4            5            6               7                     8
    query = "SELECT ID, MaxLevel, AllowableClasses, SourceSpellID, PrevQuestID, NextQuestID, ExclusiveGroup, RewardMailTemplateID, RewardMailDelay, "
    ...
    sScriptMgr->OnBeforeQuestTemplateAddonsQueried(query);
...
void ObjectMgr::LoadGameObjectTemplate()
{
    ...
    //                           0      1      2        3       4             5          6      7
    std::string query = "SELECT entry, type, displayId, name, IconName, castBarCaption, unk1, size, "
    ...
    sScriptMgr->OnBeforeGameObjectTemplateQueried(query);
