...
void ScriptMgr::OnBeforeCreatureEquipTemplateQueried(std::string& query)
{
...
void ScriptMgr::OnBeforeGameObjectTemplateAddonQueried(std::string& query)
{
...
void ScriptMgr::OnBeforeLootTemplateQueried(std::string& query, std::string lootStoreName)
{
